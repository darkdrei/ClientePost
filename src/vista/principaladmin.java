...
public class principaladmin extends javax.swing.JFrame {
    ...
    public principaladmin() {
        initComponents();
        JLabel labTab1 = new JLabel("Registro");
        labTab1.setFont(new Font(labTab1.getName(),Font.PLAIN, 20));
        labTab1.setUI(new VerticalLabelUI(false)); // true/false to make it upwards/downwards
        jTabbedPane1.setTabComponentAt(0, labTab1); // For component1
            }
    ...
    private void initComponents() {
        ...
        */
        jTabbedPane4 = new javax.swing.JTabbedPane();
        jTabbedPane2 = new javax.swing.JTabbedPane();
        jTabbedPane1 = new javax.swing.JTabbedPane(javax.swing.JTabbedPane.LEFT);

        jTabbedPane2.setFont(new java.awt.Font("Ubuntu", 0, 24)); // NOI18N
        jTabbedPane2.addTab("Tipo", jTabbedPane4);
        jTabbedPane2.addTab("Plato", jTabbedPane5);
        jTabbedPane2.addTab("Mesa", jTabbedPane6);
