...
public class factura extends javax.swing.JPanel {
    ...
    public factura(String nom, int id) {
        initComponents();
    ...
    private void initComponents() {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cbCategoria, 0, 177, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(12, 12, 12)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(btnEraseFactura, javax.swing.GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE)
                                    .addComponent(btnNewFactura, javax.swing.GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE))))))
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtTotal, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE)
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtEfectivo, javax.swing.GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE))
                .addGap(25, 25, 25))
        );
        ...
        btnCerrarCuenta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ima/cerrar_cuenta.png"))); // NOI18N
...
////        activitiOption(optVoluntaria);
    ...
    class ProducirMensaje implements Runnable {
        ...
        public ProducirMensaje(String titulo, String men, int icono, factura f) {
            this.titulo = titulo;
            this.men = men;
            this.icono = icono;
            this.f = f;
    ...
    class ConvertirMensage implements Runnable {
        ...
        public ConvertirMensage(float valor, String mesage, String titulo, factura base, int id_fact, int opcion, JRadioButton option) {
            this.valor = valor;
            this.mesage = mesage;
            this.titulo = titulo;
            this.base = base;
        ...
        public ConvertirMensage(String mesage, String titulo, factura base, int id_fact, int opcion, JRadioButton option) {
            this.mesage = mesage;
            this.titulo = titulo;
            this.base = base;
            this.id_fact = id_fact;
        ...
        public ConvertirMensage(String mesage, factura base, int id_fact) {
            this.mesage = mesage;
            this.base = base;
            this.id_fact = id_fact;
        }

        public void setBase(factura base) {
            this.base = base;
        }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        this.getDb().insertarDato(new logica.ConteFac(id_plato.get(cbPlato.getSelectedIndex() - 1), (int) jSCantidad.getValue(), id_fac));
        actualizarMatriz();
        modificarTablaDescripcion();
        deshabilitarCant();
        actualizarPrecio();
